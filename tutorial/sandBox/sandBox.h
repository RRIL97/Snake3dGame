...
public:
	...
	bool thereIsCollisionSingleTree(Eigen::AlignedBox<double, 3> boxA, igl::AABB<Eigen::MatrixXd, 3>* treeB, int id, int other_id);
	bool boxesIntersect(Eigen::AlignedBox<double, 3>& boxA, Eigen::AlignedBox<double, 3>& boxB ,int id, int other_id);
