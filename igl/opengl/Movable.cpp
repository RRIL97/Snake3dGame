...
void Movable::RotateInSystem(Eigen::Matrix3d& Mat, Eigen::Quaterniond  rot)
{ 
...
Eigen::Quaterniond Movable::GetRotationQuaterniond(){
	Eigen::Quaterniond q = Eigen::Quaterniond(Tout.rotation().matrix());
	return q;
}
