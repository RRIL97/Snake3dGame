...
namespace glfw
{
  ...
  IGL_INLINE bool Viewer::load_mesh_from_file(
      const std::string & mesh_file_name_string, const std::string& texture_name)
  {
    ...
    if (extension == "off" || extension =="OFF")
    {
      ...
      if (!igl::readOFF(mesh_file_name_string, V, F))
        return false;
      data().set_mesh(V,F,texture_name);
    }
  ...
  IGL_INLINE void Viewer::open_dialog_load_mesh()
  {
    ...
    if(filename=="zcylinder")
        this-> loadAnotherCylinder(fname.c_str());
    else this->load_mesh_from_file(fname.c_str(), "C:/Users/sabin/Downloads/EngineForAnimationCourse/tutorial/data/snake1.png");
